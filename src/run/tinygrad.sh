...
ln -s $MODEL_DIR/tokenizer.model /tmp/llama-2/tokenizer.model
...
PYTHONPATH="/tmp/tinygrad" python3 src/custom/llama_tinygrad.py --gen 2 $Q --prompt $@ --count 100 --model "/tmp/llama-2/7b"
